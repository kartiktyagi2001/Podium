    ...
    <div className="flex flex-col min-h-screen">
        ...
        <div className="mt-40 text-[#0d0117] font-serif ml-4 md:ml-6 lg:ml-45">
            ...
            <div className="mt-20">
                ...
                <button type="button" onClick={startReading} className="ml-3 text-[#ffffff] bg-gradient-to-br from-[#320044] to-purple-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-purple-500 font-medium font-sans rounded-xl shadow-lg shadow-[#250b28] text-sm px-5 py-2.5 text-center me-2 mb-2">Start Reading</button>
            </div>
